...
describe "validates_schema" do
  ...
  describe "abstract classes" do
    ...
    it "should work with parent classes that are abstract" do
      picasso = Artist.new
      picasso.should be_valid
    end
    
  end
  
  [User, People].each do |klass|
    ...
    describe klass do
      ...
      describe "valid?" do
        ...
        it "should be valid with valid attributes" do
          @user = klass.new(:password => 'password', :url => 'http://www.example.com',
